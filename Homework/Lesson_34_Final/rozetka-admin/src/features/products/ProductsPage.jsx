...
export default function ProductsPage() {
    ...
    const handleSubmit = async (product) => {
        try {
            if (editingProduct) {
                ...
                await dispatch(updateProduct({ id: editingProduct.id, ...product })).unwrap();
            } else {
    ...
    return (
        ...
        >
            ...
            >
                <ProductsTable openEdit={openEdit} openDeleteModal={openDeleteModal} />
            </Box>
            <ProductModal
                open={modalOpen}
        ...
        <Dialog open={deleteModalOpen} onClose={closeDeleteModal}>
            ...
            <DialogContent>
                <Typography>Вы уверены, что хотите удалить продукт "{productToDelete?.title}"?</Typography>
            </DialogContent>
            <DialogActions>
